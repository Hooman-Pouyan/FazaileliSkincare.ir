...
| Decision map #4        | `docs/research/shop-customer-journeys.md`                                                                          | PHP, PLP, PDP, cart                         | Entry, intent, decision risk, confidence threshold, escalation, success outcome, and metric defined for each canonical customer journey.             |
| Decision map #5        | `docs/research/shop-discovery-surfaces.md`                                                                         | PHP, PLP, search, quick view, merchandising | Browse axes, URL grammar, filters, sorting, counts, search, SEO, analytics, empty/error behavior, and mobile RTL requirements accepted.              |
| Decision map #6        | `docs/research/shop-pdp-and-guidance.md`                                                                           | PDP content and trust/safety                | Suitability, claims, usage, evidence, origin, variants, availability, restrictions, escalation, structured data, and safety boundaries accepted.     |
