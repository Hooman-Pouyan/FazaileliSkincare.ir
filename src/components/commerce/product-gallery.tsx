  ...
  return (
    <div className={cn("flex flex-col gap-3", className)}>
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-[var(--sand)]">
        {images[active] ? (
          <Image src={images[active]!} alt={alt} fill priority sizes="(max-width: 1024px) 100vw, 640px" className="object-cover" />
        ) : (
            ...
            <li key={src}>
              <button
                ...
                className={cn(
                  ...
                  i === active ? "border-[var(--gold)]" : "border-transparent hover:border-[var(--hairline)]",
                )}
              >
