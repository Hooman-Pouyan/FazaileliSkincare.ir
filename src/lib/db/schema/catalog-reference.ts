...
export const brandTranslation = pgTable(
  ...
  (table) => [
    ...
    index("brand_translation_name_idx").on(
      table.localeCode,
...
export const productLineTranslation = pgTable(
  ...
  (table) => [
    ...
    index("product_line_translation_name_idx").on(
      table.localeCode,
      table.normalizedName,
    ),
  ],
...
export const categoryTranslation = pgTable(
  ...
  (table) => [
    ...
    index("category_translation_name_idx").on(
      table.localeCode,
      table.normalizedName,
    ),
  ],
...
export const concernTranslation = pgTable(
  "concern_translation",
  {
    concernId: uuid()
      .notNull()
  ...
  (table) => [
    ...
    index("concern_translation_name_idx").on(
      table.localeCode,
      table.normalizedName,
    ),
  ],
...
export const skinState = pgTable(
  "skin_state",
  {
    id: uuid().primaryKey().defaultRandom(),
    slug: text().notNull(),
...
export const skinStateTranslation = pgTable(
  ...
  (table) => [
    ...
    index("skin_state_translation_name_idx").on(
      table.localeCode,
      table.normalizedName,
    ),
  ],
...
export const protocolTranslation = pgTable(
  ...
  (table) => [
    ...
    index("protocol_translation_name_idx").on(
      table.localeCode,
      table.normalizedName,
    ),
  ],
...
export const protocolPhase = pgTable(
  "protocol_phase",
  {
    id: uuid().primaryKey().defaultRandom(),
    protocolId: uuid()
  ...
  (table) => [
    uniqueIndex("protocol_phase_protocol_slug_unique").on(
      table.protocolId,
      table.slug,
    ),
...
export const protocolPhaseTranslation = pgTable(
  ...
  (table) => [
    ...
    index("protocol_phase_translation_name_idx").on(
      table.localeCode,
      table.normalizedName,
    ),
  ],
