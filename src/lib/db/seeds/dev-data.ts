...
export const DEV_PRODUCTS = [
  {
    ...
    skinStateSlugs: ["dry", "sensitive", "normal"],
    phaseSlugs: ["cleanse"],
  ...
  },
  {
    ...
    skinStateSlugs: ["combination", "oily"],
    phaseSlugs: ["treat"],
    isProfessionalOnly: false,
    priceVisibility: "public",
    reviewState: "approved",
  ...
  },
  {
    ...
    categorySlug: "dev-serum",
    concernSlugs: ["acne"],
    skinStateSlugs: ["oily", "combination"],
    phaseSlugs: ["treat"],
    isProfessionalOnly: false,
  ...
  },
  {
    ...
    skinStateSlugs: ["normal", "combination"],
    phaseSlugs: ["treat"],
  ...
  },
  {
    ...
    skinStateSlugs: ["oily", "normal"],
    phaseSlugs: ["cleanse", "hydrate"],
    isProfessionalOnly: false,
    priceVisibility: "public",
    reviewState: "approved",
    isPublished: true,
