...
/**
 * Products for one skin concern — the site's primary browsing axis, and the one the dominant Iranian competitor does not offer at all.
 *
...
export default function Page({ params, searchParams }: Props) {
  return (
    <ListingRoute
      ...
      scope={(slug) => ({ kind: "concern", slug: slug ?? "" })}
    />
  );
}
